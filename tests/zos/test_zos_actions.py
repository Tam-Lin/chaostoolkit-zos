...
'MIF ID   MULTIPLE IMAGE FACILITY IMAGE IDENTIFIER             '
    ...
    send_command.assert_any_call(location="SYS1", connection_information="password1", command_to_send="CF CORE(0007),OFFLINE", message_to_watch_for="IEE505I")
    send_command.assert_any_call(location="SYS1", connection_information="password1", command_to_send="CF CORE(0008),OFFLINE", message_to_watch_for="IEE505I")
    send_command.assert_any_call(location="SYS1", connection_information="password1", command_to_send="CF CORE(0009),OFFLINE", message_to_watch_for="IEE505I")
